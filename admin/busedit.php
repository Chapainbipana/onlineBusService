  ...
  <div class="container d-flex justify-content-around">
    ...
    <form action="buseditvalue.php" method="post" class="p-5 bg-white m-5 shadow" onsubmit=" return itsfunction()" >
          ...
          <div class="mb-3">
                ...
                <input type="text" class="form-control"  name="bphone" pattern="\d{10}" value="<?php echo $res['phone']; ?>" required>
         </div>
         <div class="mb-3">
                <label for="b_source" class="form-label">Drive Number</label>
                <input type="text" class="form-control" name="drivename" value="<?php echo $res['driver_name']; ?>" required>
         </div>
         <div class="mb-3">
