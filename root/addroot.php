                            ...
                            <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    <label for="cdate" class="form-label">Date :</label>
                                     <input type="datetime-local" class="form-control" id="cdate" name="cdate" min="1" max="30" value="<?php echo $res['date']; ?>" required>
                                 </div>
                              <div class="mb-3">
                              <label for="csource" class="form-label">Source:</label>
                             
                              <select class="form-select form-select-lg mb-3" aria-label=".form-select-lg example" name="soruce">
                              <?php
                              while ($res=mysqli_fetch_assoc($result)){   
     ?>     
                              <option value="<?php echo $res['source']?>"><?php echo $res['source']; ?></option>
                              <?php
                              }
                              ?>
                              </select>
                          ...
                          <div class="mb-3">
                             ...
                             <?php
                              while ($res=mysqli_fetch_assoc($result)){   
     ?>     
                              <option value="<?php echo $res['destination']?>"><?php echo $res['destination']; ?></option>
                              <?php
                              }
                              ?>
